...
# Load your data file
data = pd.read_csv('county-legislature.csv', delimiter=',')
...
output_filepath_chi_square = 'chi_square_results_with_female_representation_score_by_fips_legislature.csv'
