...
const svg = d3.select("#map_chi_legislature").append("svg")
    .attr("width", width)
    .attr("height", height);
...
const tooltip = d3.select(".tooltip_chi_legislature")
    .style("opacity", 0);
...
const legend = svg.append("g")
    .attr("class", "legend")
    .attr("id", "map-legend_chi_legislature") // Unique ID for the legend
