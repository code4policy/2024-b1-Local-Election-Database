...
# Load your data file
data = pd.read_csv('data/county-legislature.csv', delimiter=',')

# Check the first few rows of the DataFrame to see the column headers.
print(data.head())
...
output_filepath_chi_square = 'data/chi_square_results_with_female_representation_score_by_fips_legislature.csv'
